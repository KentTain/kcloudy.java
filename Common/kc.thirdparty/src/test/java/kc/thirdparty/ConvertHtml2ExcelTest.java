...
class ConvertHtml2ExcelTest {
	...
	private String getExportHtml() {
		...
		StringBuilder sbContent = new StringBuilder(
				"<table cellspacing='0' cellpadding='0' style='border-collapse:collapse; float:left; margin:0pt 9pt; width:100%'>");
		// table head
		sbContent.append(String.format("<thead><tr style='height:24.65pt'>"
				...
				+ "</tr></thead>", theadStyle, theadPStyle, spanStyle));
		// table body
		...
		// 一级-->二级-->三级-->扣分标准
		sbContent.append(String.format(
				...
				theadStyle, theadPStyle, spanStyle, level1Name, level2Name, level3Name, level3Content, factorContent,
				level3SumActualScore, level3Score, factorFileName, factorFileCode, factorIsFit, factorNextWork,
				factorPersonCompany, factorPersonName, factorPersonPhone, factorReason, factorRemark, solutionLeadName,
				solutionUnitName, solutionProcess));

		// 扣分标准
		sbContent.append(String.format("<tr style='height:15.75pt'>" +
		// "<td rowspan='7' style='width:4%%; %1$s'><span style='%3$s'>%4$s</span></td>"
		// +
		// "<td rowspan='4' style='width:3.7%%; %1$s'><span
		// style='%3$s'>%5$s</span></td>" +
		// "<td rowspan='2' style='width:4.88%%; %1$s'><span
		// style='%3$s'>%6$s</span></td>" +
		// "<td rowspan='2' style='width:7.8%%; %1$s'><span
		// style='%3$s'>%7$s</span></td>" +
				"<td style='width:2.2%%; %1$s'><span style='%3$s'>%8$s</span></td>" +
				// "<td rowspan='2' style='width:2.2%%; %1$s'><span
				// style='%3$s'>%9$s</span></td>" +
				// "<td rowspan='2' style='width:5.82%%; %1$s'><span
				// style='%3$s'>%10$s</span></td>" +
				"<td style='width:5.82%%; %1$s'><span style='%3$s'>%11$s</span></td>"
				+ "<td style='width:5.82%%; %1$s'><span style='%3$s'>%12$s</span></td>"
				+ "<td style='width:5.82%%; %1$s'><span style='%3$s'>%13$s</span></td>"
				+ "<td style='width:5.82%%; %1$s'><span style='%3$s'>%14$s</span></td>"
				...
				+ "<td style='width:5.12%%; %1$s'><span style='%3$s'>%18$s</span></td>"
				+ "<td style='width:5.12%%; %1$s'><span style='%3$s'>%19$s</span></td>" +
				// "<td rowspan='2' style='width:6.56%%; %1$s'><span
				// style='%3$s'>%20$s</span></td>" +
				// "<td rowspan='2' style='width:4.98%%; %1$s'><span
				// style='%3$s'>%21$s</span></td>" +
				// "<td rowspan='2' style='width:3.7%%; %1$s'><span
				// style='%3$s'>%22$s</span></td>" +
				"</tr>", theadStyle, theadPStyle, spanStyle, level1Name, level2Name, level3Name, level3Content,
				factorContent, level3SumActualScore, level3Score, factorFileName, factorFileCode, factorIsFit,
				factorNextWork, factorPersonCompany, factorPersonName, factorPersonPhone, factorReason, factorRemark,
				solutionLeadName, solutionUnitName, solutionProcess));
		...
		// style='%3$s'>%5$s</span></td>" +
				...
				+ "<td rowspan='2' style='width:6.56%%; %1$s'><span style='%3$s'>%20$s</span></td>"
				+ "<td rowspan='2' style='width:4.98%%; %1$s'><span style='%3$s'>%21$s</span></td>"
				+ "<td rowspan='2' style='width:3.7%%; %1$s'><span style='%3$s'>%22$s</span></td></tr>", theadStyle,
				theadPStyle, spanStyle, level1Name, level2Name, level3Name, level3Content, factorContent,
				level3SumActualScore, level3Score, factorFileName, factorFileCode, factorIsFit, factorNextWork,
				factorPersonCompany, factorPersonName, factorPersonPhone, factorReason, factorRemark, solutionLeadName,
				solutionUnitName, solutionProcess));
		// 扣分标准
		...
		// +
				...
				+ "<td rowspan='1' style='width:3.7%%; %1$s'><span style='%3$s'>%22$s</span></td></tr>", theadStyle,
				theadPStyle, spanStyle, level1Name, level2Name, level3Name, level3Content, factorContent,
				level3SumActualScore, level3Score, factorFileName, factorFileCode, factorIsFit, factorNextWork,
				factorPersonCompany, factorPersonName, factorPersonPhone, factorReason, factorRemark, solutionLeadName,
				solutionUnitName, solutionProcess));
		...
		// "<td rowspan='7' style='width:4%%; %1$s'><span style='%3$s'>%4$s</span></td>"
		// +
		// "<td rowspan='3' style='width:3.7%%; %1$s'><span
		// style='%3$s'>%5$s</span></td>" +
				"<td rowspan='2' style='width:4.88%%; %1$s'><span style='%3$s'>%6$s</span></td>"
				+ "<td rowspan='2' style='width:7.8%%; %1$s'><span style='%3$s'>%7$s</span></td>"
				+ "<td style='width:2.2%%; %1$s'><span style='%3$s'>%8$s</span></td>"
