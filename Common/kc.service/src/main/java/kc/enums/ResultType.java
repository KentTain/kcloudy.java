...
public enum ResultType implements EnumBase {
	 ...
	 * ContentResult
	 */
	ContentResult("ContentResult", 2),

	/**
	 * RedirectResult
	 */
	RedirectResult("RedirectResult", 3),

	/**
	 * ImageResult
	 */
	ImageResult("ImageResult", 4);
	...
	private ResultType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ResultType valueOf(Integer index) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<ResultType> exceptEnums) {
