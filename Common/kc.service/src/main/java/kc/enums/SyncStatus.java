...
public enum SyncStatus implements EnumBase {
	...
	private SyncStatus(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static SyncStatus valueOf(Integer index) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<SyncStatus> exceptEnums) {
