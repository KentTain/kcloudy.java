...
public enum MessageStatus implements EnumBase {
	/**
	 * 未读
	 */
	Unread("未读", 0),
	...
	private MessageStatus(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<MessageStatus> exceptEnums) {
