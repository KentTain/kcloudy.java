...
public enum VideoFormat implements EnumBase{
	Wmv("Wmv", 1), Mp4("Mp4", 2),Flv("flv", 3),
	Avi("avi", 4),Mov("mov", 5),
	...
	private VideoFormat(String desc, Integer index) {
			this.desc = desc;
			this.index = index;
		}
	...
	public static VideoFormat valueOf(Integer index) {
		for (VideoFormat type : values()) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<VideoFormat> exceptEnums) {
