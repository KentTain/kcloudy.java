 ...
 * @author tianc 日志类型
 */
public enum ProcessLogType implements EnumBase {
	/**
	 * 成功
	 */
	Success("Success", 0),
	...
	private ProcessLogType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ProcessLogType valueOf(Integer index) {
		for (ProcessLogType type : values()) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<ProcessLogType> exceptEnums) {
