...
public enum WorkflowFormType implements EnumBase{
	/**
	 * 表单数据接入
	 */
	ModelDefinition("表单数据接入", 0),

	/**
	 * 表单地址接入
	 */
	FormAddress("表单地址接入", 1),
	...
	private WorkflowFormType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static WorkflowFormType valueOf(Integer index) {
		for (WorkflowFormType type : values()) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<WorkflowFormType> exceptEnums) {
