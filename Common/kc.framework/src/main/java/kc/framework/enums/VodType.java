...
public enum VodType implements EnumBase{
	/**
	 * Azure
	 */
	Azure("Azure", 0),
	...
	private VodType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static VodType valueOf(Integer index) {
		for (VodType type : values()) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<VodType> exceptEnums) {
