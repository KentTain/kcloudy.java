...
public enum RuleType implements EnumBase {
	/**
	 * 无
	 */
	None("无", 0),
	...
	private RuleType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static RuleType valueOf(Integer index) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<RuleType> exceptEnums) {
