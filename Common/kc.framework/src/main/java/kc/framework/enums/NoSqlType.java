...
public enum NoSqlType implements EnumBase{
	/**
	 * AzureTable
	 */
	AzureTable("AzureTable", 0),
	...
	private NoSqlType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static NoSqlType valueOf(Integer index) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<NoSqlType> exceptEnums) {
