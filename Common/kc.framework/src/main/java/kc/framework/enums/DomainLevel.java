...
public enum DomainLevel implements EnumBase{
	/**
	 * 一级域名
	 */
	LevelOne("一级域名", 0),
	...
	private DomainLevel(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static DomainLevel valueOf(Integer index) {
		for (DomainLevel type : values()) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<DomainLevel> exceptEnums) {
