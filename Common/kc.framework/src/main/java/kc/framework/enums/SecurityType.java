...
public enum SecurityType implements EnumBase{
	/**
	 * 安全码
	 */
	SecurityKey("安全码", 0),
	...
	private SecurityType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static SecurityType valueOf(Integer index) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<SecurityType> exceptEnums) {
