...
public enum TenantType implements EnumBase{
	/**
	 * 企业
	 */
	Enterprise("企业", 0x01),
	...
	private TenantType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static TenantType valueOf(Integer index) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<TenantType> exceptEnums) {
