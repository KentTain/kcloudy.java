...
public enum ServiceBusType implements EnumBase{
	/**
	 * ServiceBus
	 */
	...
	private ServiceBusType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ServiceBusType valueOf(Integer index) {
		for (ServiceBusType type : values()) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<ServiceBusType> exceptEnums) {
