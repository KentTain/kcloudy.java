...
public enum SystemType implements EnumBase {
	Dev("开发环境", 0),
	Test("测试环境", 1),
	Beta("准生产环境", 2),
	Product("生产环境", 3);
	...
	private SystemType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static SystemType valueOf(Integer index) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<SystemType> exceptEnums) {
