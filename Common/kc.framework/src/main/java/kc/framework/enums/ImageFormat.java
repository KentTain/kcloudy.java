...
public enum ImageFormat implements EnumBase{
	Bmp("Bmp", 1), Gif("Gif", 2), Icon("Icon", 3),
	Jpeg("Jpeg", 4), Png("Png", 5), Tiff("Tiff", 6),
	Wmf("Wmf", 7),Dwg("Dwg", 8),
	...
	private ImageFormat(String desc, int index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ImageFormat valueOf(int index) {
	 ...
	 * @return Map<Integer, String>
	 */
	public static java.util.Map<Integer, String> getList(List<ImageFormat> exceptEnums) {
