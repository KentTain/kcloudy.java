...
public class HomeController extends WebBaseController {
	 ...
	 * 一级菜单：字典管理
	 */
	@MenuAnnotation(ParentMenuName = "字典管理", MenuName = "字典管理", Url = "/Home/Dictionary",
            Version = TenantConstant.DefaultVersion, TenantType = TenantConstant.DefaultTenantType, SmallIcon = "fa fa-book",
            AuthorityId = "21E87C50-B014-40BD-ADD7-01C64513FD3A",
            DefaultRoleId = RoleConstants.AdminRoleId, Order = 1, IsExtPage = false, Level = 2)   
	@RequestMapping("/Home/Dictionary")
	public String Dictionary()
	{
		return super.ThrowErrorJsonMessage(true, "菜单-字典管理");
	}
