...
//            ResultType = ResultType.ActionResult, AuthorityId = ApplicationConstant.DefaultAuthorityId)
     ...
     * 一级菜单：代码生成管理
     */
    @MenuAnnotation(ParentMenuName = "代码生成管理", MenuName = "代码生成管理", Url = "/Home/CodeGenerate",
    ...
    @RequestMapping("/Home/CodeGenerate")
     ...
     * 二级菜单：代码生成管理/模型管理
     */
    @MenuAnnotation(ParentMenuName = "代码生成管理", MenuName = "模型管理", Url = "/Home/ModelDefinition",
            Version = TenantConstant.DefaultVersion, TenantType = TenantConstant.DefaultTenantType,
    ...
    @RequestMapping("/Home/ModelDefinition")
    public String ModelDefinition() {
        return super.ThrowErrorJsonMessage(true, "菜单-模型管理");
    }
