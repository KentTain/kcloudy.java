...
//            ResultType = ResultType.ActionResult, AuthorityId = ApplicationConstant.DefaultAuthorityId)
	...
	@MenuAnnotation(ParentMenuName = "配置管理", MenuName = "配置管理", Url = "/Home/Config",
            Version = TenantConstant.DefaultVersion, TenantType = TenantConstant.DefaultTenantType, SmallIcon = "fa fa-file-code-o",
            AuthorityId = "A015AC93-7222-4918-8CD8-E73E6720E087",
