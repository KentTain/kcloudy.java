 ...
 * 商品类型
 */
public enum ServiceDataType implements EnumBase {
    /**
     * 文本框列表
     */
    TextList("文本框列表", 0),
    ...
    private ServiceDataType(String desc, Integer index) {
        this.desc = desc;
        this.index = index;
    }
    ...
    public static ServiceDataType valueOf(Integer index) {
        for (ServiceDataType type : values()) {
     ...
     */
    public static java.util.Map<Integer, String> getList(List<ServiceDataType> exceptEnums) {
