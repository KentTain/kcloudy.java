...
public enum ApiInputBodyType implements EnumBase {
	...
	private ApiInputBodyType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ApiInputBodyType valueOf(Integer index) {
		for (ApiInputBodyType type : values()) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<ApiInputBodyType> exceptEnums) {
