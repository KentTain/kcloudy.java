...
public enum PrimaryKeyType implements EnumBase {
	/**
	 * 自增
	 */
	IDENTITY("自增", 0),
	...
	private PrimaryKeyType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static PrimaryKeyType valueOf(Integer index) {
		for (PrimaryKeyType type : values()) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<PrimaryKeyType> exceptEnums) {
