...
public enum ApiStatus implements EnumBase {
	...
	private ApiStatus(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ApiStatus valueOf(Integer index) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<ApiStatus> exceptEnums) {
