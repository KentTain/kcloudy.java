...
public enum RelationType implements EnumBase {
	...
	private RelationType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static RelationType valueOf(Integer index) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<RelationType> exceptEnums) {
