...
public enum ApiOutReturnType implements EnumBase {
	...
	private ApiOutReturnType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ApiOutReturnType valueOf(Integer index) {
		for (ApiOutReturnType type : values()) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<ApiOutReturnType> exceptEnums) {
