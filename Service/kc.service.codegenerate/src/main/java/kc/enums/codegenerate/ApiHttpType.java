...
public enum ApiHttpType implements EnumBase {
	...
	private ApiHttpType(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static ApiHttpType valueOf(Integer index) {
		for (ApiHttpType type : values()) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<ApiHttpType> exceptEnums) {
