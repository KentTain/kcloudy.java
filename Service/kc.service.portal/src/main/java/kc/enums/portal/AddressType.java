...
public enum AddressType implements EnumBase {
     ...
     * 公司地址
     */
    CompanyAddress("公司地址", 0),

    /**
     * 收货地址
     */
    ShippingAddress("收货地址", 1),

    /**
     * 发货地址
     */
    DeliveryAddress("发货地址", 2);
    ...
    private AddressType(String desc, Integer index) {
        this.desc = desc;
        this.index = index;
    }
    ...
    public static AddressType valueOf(Integer index) {
     ...
     */
    public static java.util.Map<Integer, String> getList(List<AddressType> exceptEnums) {
