...
public enum ArticleType  implements EnumBase {
    ...
    private ArticleType(String desc, Integer index) {
        this.desc = desc;
        this.index = index;
    }
    ...
    public static ArticleType valueOf(Integer index) {
     ...
     */
    public static java.util.Map<Integer, String> getList(List<ArticleType> exceptEnums) {
