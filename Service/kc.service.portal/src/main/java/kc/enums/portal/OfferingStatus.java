 ...
 * 商品状态
 */
public enum OfferingStatus implements EnumBase {
    /**
     * 草稿
     */
    Draft("草稿", 0),
    ...
    private OfferingStatus(String desc, Integer index) {
        this.desc = desc;
        this.index = index;
    }
    ...
    public static OfferingStatus valueOf(Integer index) {
        for (OfferingStatus type : values()) {
     ...
     */
    public static java.util.Map<Integer, String> getList(List<OfferingStatus> exceptEnums) {
