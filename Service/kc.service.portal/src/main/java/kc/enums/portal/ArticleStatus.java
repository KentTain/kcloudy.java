...
public enum ArticleStatus implements EnumBase {
    /**
     * 草稿
     */
    Draft("草稿", 0),
    ...
    private ArticleStatus(String desc, Integer index) {
        this.desc = desc;
        this.index = index;
    }
    ...
    public static ArticleStatus valueOf(Integer index) {
     ...
     */
    public static java.util.Map<Integer, String> getList(List<ArticleStatus> exceptEnums) {
