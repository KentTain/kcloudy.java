...
public enum AccountStatus implements EnumBase {
	...
	private AccountStatus(String desc, Integer index) {
		this.desc = desc;
		this.index = index;
	}
	...
	public static AccountStatus valueOf(Integer index) {
	 ...
	 */
	public static java.util.Map<Integer, String> getList(List<AccountStatus> exceptEnums) {
